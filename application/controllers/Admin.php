...
class Admin extends CI_Controller
{
  ...
  public function __construct()
  {
    ...
    public function index()
    {
      ...
      $this->load->model('Alumni_model','jml');
      $this->load->model('Dosen_model','jmla');
      $this->load->model('Tridar_model','jmlaa');
      // $this->load->model('User_model','pengguna');
      $data['jml'] = $this->jml->jmlalumni();
      $data['jmldosen'] = $this->jmla->jmldosen();
      $data['jmlpenelitian'] = $this->jmlaa->jmlpenelitian();
      $data['jmlpengabdian'] = $this->jmlaa->jmlpengabdian();
