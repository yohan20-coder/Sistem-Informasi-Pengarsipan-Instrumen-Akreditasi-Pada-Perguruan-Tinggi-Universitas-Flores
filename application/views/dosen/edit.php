...
<div class="container-fluid">
        ...
        <form action="<?= base_url();?>dosen/edit/<?= $edit['id'] ?>" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nidn" value="<?= $edit['nidn'];?>" >
              ...
              <div class="col-sm-10">
         	    ...
         	    <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="ttl"  value="<?= $edit['ttl'];?>">
                   <?= form_error('ttl','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="ibu"  value="<?= $edit['ibu'];?>">
                   <?= form_error('ibu','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="rtw"  value="<?= $edit['rtw'];?>">
                   <?= form_error('rtw','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="kelur"  value="<?= $edit['kelurahan'];?>">
                   <?= form_error('kelur','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="kab"  value="<?= $edit['kabupaten'];?>">
                   <?= form_error('kab','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="prov"  value="<?= $edit['propinsi'];?>">
                   ...
                   <?= form_error('hp','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="pangkat"  value="<?= $edit['pangkat'];?>">
                   <?= form_error('pangkat','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="nosk"  value="<?= $edit['nosk'];?>">
                   <?= form_error('nosk','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="date" class="form-control" name="tgl"  value="<?= $edit['tgl'];?>">
