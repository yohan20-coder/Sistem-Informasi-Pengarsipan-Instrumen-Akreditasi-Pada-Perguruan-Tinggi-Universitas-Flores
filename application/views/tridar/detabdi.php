         ...
         <div class="row">
         	<div class="col-lg-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nidn" value="<?= $detail['nidn'];?>" readonly>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama" value="<?= $detail['nama_dosen'];?>" readonly>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="judul" value="<?= $detail['judul_pengabdian'];?>" readonly>
         	    ...
         	    <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="tahun" value="<?= $detail['tahun'];?>" readonly>
                   <?= form_error('tahun','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="lama" value="<?= $detail['lama_kegiatan'];?>" readonly>
                   <?= form_error('lama','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="afiliasi" value="<?= $detail['afiliasi'];?>" readonly>
                   <?= form_error('afiliasi','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="kelompok" value="<?= $detail['kelompok_bidang'];?>" readonly>
                   <?= form_error('kelompok','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="nosk" value="<?= $detail['no_sk_tugas'];?>" readonly>
                   <?= form_error('nosk','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="tglsk" value="<?= $detail['tgl_sk_tugas'];?>" readonly>
                   <?= form_error('tglsk','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="text" class="form-control" name="lokasi" value="<?= $detail['lokasi_kegiatan'];?>" readonly>
                   <?= form_error('lokasi','<small class="text-danger pl-3">', '</small>'); ?>
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                   <input type="number" class="form-control" name="thnpel" value="<?= $detail['tahun_pelaksanaan'];?>" readonly>
                ...
                <div class="form-group row justify-content-end">
                            <div class="col-sm-10">
                            <a href="<?= base_url();?>tridar/editabdi/<?= $detail['id'] ?>" class="btn btn-sm btn-primary">Edit Data</a>
                            </div>
                         </div>
